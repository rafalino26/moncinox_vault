...
export default function StatCards({ wallets, onDataUpdate }: {
    ...
    // Hapus useEffect untuk mengambil data dari sini
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <button onClick={() => handleCardClick('Saya')} className="text-left">
                        <StatCard title="Sisa Uang Rafa" value={formatRupiah(wallets.rafaWallet?.balance)} Icon={FiPocket} color="bg-blue-500" ActionIcon={FiPlus} />
                    </button>
                    <button onClick={() => handleCardClick('Pacar_Saya')} className="text-left">
                        <StatCard title="Sisa Uang Monik" value={formatRupiah(wallets.monikWallet?.balance)} Icon={FiPocket} color="bg-pink-500" ActionIcon={FiPlus} />
                    </button>
                </div>
            </div>
